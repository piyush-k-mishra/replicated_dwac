...
class AttentionRnnDwac(object):
    def __init__(self, args, vocab, embeddings_matrix):
        self.device = args.device
        self.n_classes = args.n_classes
        self.eps = args.eps

        self.model = AttentionRnnDwacModule(args, vocab, embeddings_matrix).to(self.device)
...
class AttentionRnnDwacModule(nn.Module):
    def __init__(self, args, vocab, embeddings_matrix):
        super(AttentionRnnDwacModule, self).__init__()
        self.device = args.device
